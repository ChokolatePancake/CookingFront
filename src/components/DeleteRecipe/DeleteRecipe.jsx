...
import {useRemoveRecipeMutation} from "../../redux/api/cookingForumApi";
import {Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle} from "@mui/material";

const DeleteRecipe = ({recipeId}) => {
    const isAuth = useSelector(state => state.auth.isAuthenticated);
    const [deleteRecipe, deleteRecipeData] = useRemoveRecipeMutation();
    ...
    return (
        <div>
            <svg onClick={() => setOpenDialog(true)} fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" viewBox="0 0 482.428 482.429">
<g>
	<g>
